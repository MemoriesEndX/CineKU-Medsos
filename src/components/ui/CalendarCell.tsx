...
export function CalendarCell({ state, date }: CalendarCellProps) {
  ...
  const isSelectionStart =
    'highlightedRange' in state && state.highlightedRange // This is a type guard to check whether state is of type `RangeCalendarState`
      ? isSameDay(date, state.highlightedRange.start)
      : isSelected;
  const isSelectionEnd =
    'highlightedRange' in state && state.highlightedRange ? isSameDay(date, state.highlightedRange.end) : isSelected;
